        ...
        if (int(hot_gpu) >= int(terget_temp_max) -2) or (int(mem_t) >= 100):   
            ...
            if (optimum_on == 0) and (stable_temp_round <= 15) and (int(mem_t) <100):
                ...
                if  (int(mem_t) >= 88) or (int(optimum_temp) == int(hot_gpu)) or (int(last_rpm) == 1):
                    print('optTRIGER', int(mem_t) >= int(target_mem_temp) , int(optimum_temp) == int(hot_gpu), (int(last_rpm) == 1))                                                             
                    optimum_on = 1                                                                                                                   
                ...
                stab_balance =    (int(hot_gpu) - int(temp_gpu_freeze)) * ((int(const_rpm) / 100)*4) #int((int(const_rpm) / 100) * ((int(hot_gpu) - int(temp_gpu_freeze))*2.5)) 
                stab_balance_mem =  (int(mem_t) - int(target_mem_temp)) * ((int(const_rpm) / 100)*3) #int((int(const_rpm) / 100) * ((int(mem_t) - (int(target_mem_temp)-2))*1.5))
